    ...
    return (
        <main>
            ...
            <div className="bg-primary m-20">
                <div className="flex flex-col lg:flex-row justify-center items-center gap-20 px-20 py-20">
                    <div className="w-1/2 h-full flex flex-col justify-center gap-8">
                        ...
                        <button className='w-1/2 bg-black text-white p-4 hover:bg-black/50 self-center rounded-sm breadtext'>Explore your own motherstructure</button>
                    </div>
            ...
            <div className="bg-white">
                <div className="flex flex-col lg:flex-row justify-center items-center gap-20 px-20 py-20">
                    <Image src="/images/outdoor2.jpg" width={600} height={400} className="w-1/2 rounded-sm" alt="outdoor" />
                    <div className="w-1/3 flex flex-col justify-center gap-8 text-pretty">
                        ...
                        <button className='bg-black text-white p-4 hover:bg-black/50 self-start rounded-sm breadtext'>See what we have built</button>
                    </div>
                </div>
            </div>
            <div className="bg-secondary m-20">
                <div className="flex flex-col lg:flex-row justify-center items-center gap-20 px-20 py-20">              
                    <div className="w-1/3 flex flex-col justify-center gap-8 text-pretty">
                        ...
                        <button className='bg-black text-white p-4 hover:bg-black/50 self-start rounded-sm breadtext'>Lear more about our designs</button>
                    </div>
                    <Image src="/images/outdoor2.jpg" width={600} height={400} className="w-1/2 rounded-sm" alt="outdoor" />
                </div>
            </div>
            <div className="bg-white">
                <div className="flex flex-col lg:flex-row justify-center items-center gap-20 px-20 py-20">
                    ...
                    <div className="w-1/3 flex flex-col justify-center gap-8 text-pretty">
                        ...
                        <button className='bg-black text-white p-4 hover:bg-black/50 self-start rounded-sm breadtext'>Get inspired</button>
                    </div>
                </div>
            </div>
            <FAQ />
