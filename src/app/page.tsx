	...
	return (
		<main>
            ...
            <div className="w-full h-[40vh] md:h-[75vh] lg:h-screen flex flex-col justify-center items-center mix-blend-normal">
                <h1 className='invisible sm:visible lg:px-20 lg:text-[2.5rem] xl:text-[3.5rem]'>Bridging the gap between indoors and outdoors</h1>
                <p className="hidden lg:visible py-4 l wrap-balance text-[1.3rem]">We build super light modular structures that can weather all seasons. <br></br> Our goal is to blend the joy of being outside with the comforts of being inside. </p>
            </div>
            <div className='w-full flex flex-col gap-8 lg:gap-12 pb-12 items-center justify-around'>
                ...
                <Image src='/images/outdoor2.jpg' width={1000} height={550} alt='outdoors' className='lg:rounded-2xl'/>
            </div>
        </main>
	);
};
